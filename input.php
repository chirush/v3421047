              ...
              <form method="post" action="function.php">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="radio" id="Belum Menikah" name="kawin" value="Belum Menikah" />  Belum Menikah<br/>
                    <input type="radio" id="Menikah" name="kawin" value="Menikah" />  Menikah
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    <label for="kewarganegaraan">Kewarganegaraanan</label><br/>
                    <input type="radio" id="WNI" name="kewarganegaraan" value="WNI" />  WNI<br/>
                    <input type="radio" id="WNA" name="kewarganegaraan" value="WNA" />  WNA
                  </div>
                  <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" class="form-control" name="tgllahir" class="form-control" id="tgllahir">
                  </div>
                  <div class="form-group">
                    <label for="golongandarah">Golongan Darah</label>
                    <input type="text" class="form-control" name="golongandarah" class="form-control" id="golongandarah" maxlength="2">
                  </div>
                </div>
                <!-- /.card-body -->
